                   ...
                   child: Column(children: [
                       ...
                       children: [
                         ...
                         Positioned(
                           ...
                           child: Container(
                             ...
                             child: IconButton(icon: const Icon(Icons.edit, color: pink, size: 15,), onPressed: () { 
                               ImagePickerClass newImagePicker = ImagePickerClass();
                               newImagePicker.showImagePicker(context, auth.usuario!.uid, snapshot.data!["imagem"]);
                         ...
                         child: Padding(
                           ...
                           child: ListTile(
                             ...
                             trailing: CircleAvatar(
                               backgroundColor: blue,
                               child: IconButton(icon: const Icon(Icons.edit, color: pink,), onPressed: (){
                       ...
                       child: Container(
                         ...
                         child: Padding(
                           ...
                           child: ListTile(
                             ...
                             trailing: CircleAvatar(
                               backgroundColor: blue,
                               child: IconButton(icon: const Icon(Icons.edit, color: pink,), onPressed: (){modalSenha(context, snapshot.data!["email"], auth.usuario!.uid);},),
                             ),
                             ),
                         ),
                       ),
                    ...
                    Padding(
                      ...
                      child: TextButton(onPressed: () async {
                        ...
                        children: const [
                          Text("Sair da Conta ", style: TextStyle(color: pink, fontSize: 22),),
                          Icon(Icons.supervised_user_circle, color: pink, size: 30,)
                        ],
                      )),
                    )
                   ]),
